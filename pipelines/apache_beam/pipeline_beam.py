...
pipeline_name = "LUNG_CANCER-DETECTION-TFX"

# pipeline inputs
pipeline_dir = os.getcwd()
data_dir = os.path.join(pipeline_dir, "tfrecordImagesData")
...
def init_beam_pipeline(
    ...
    # Ensure that beam_arg is a tuple and any additional args are also tuples
    beam_pipeline_args =  tuple()  # Add additional arguments if needed as a tuple
    ...
    p = pipeline.Pipeline(
        ...
        beam_pipeline_args=beam_pipeline_args,  # Ensure this is a tuple
    )
    return p
